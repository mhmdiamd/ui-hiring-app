    ...
    <main className='overflow-hidden'>
      <div className={`${style.authContainer} container-fluid loginPage`}>
        <div className="row h-100 d-flex">
          <div className={`col-md-6 ${style.sideLeft} position-fixed p-4 min-vh-100 d-md-flex d-none`}>
            <div className="row">
              ...
              <div className="col-12 col-lg-8 h-100 d-flex ps-2 ps-lg-5 align-items-center">
                <span className="fs-1 fw-semibold text-light">Temukan developer berbakat & terbaik di berbagai bidang keahlian</span>
              </div>
            </div>
          </div>
          <div className={`col-md-6 ${style.sideRight} offset-md-6 pt-3 min-vh-100 d-grid align-items-center`}>
