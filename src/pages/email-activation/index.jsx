...
import {useWorkerEmailActivationQuery} from '@/features/auth/worker/workerApi'
...
const EmailActivation = () => {
  ...
  const {data, isLoading, isSuccess, isError} = useWorkerEmailActivationQuery(router?.query?.token, {skip: router.query.token ? false: true})
